...
# Vendored into anima-lora-trainer. ComfyUI/comfy_kitchen couplings are replaced
# by pure-PyTorch shims (see shims.py) so this runs standalone on CPU/CUDA/XPU.
...
try:
    from torchvision import transforms  # only needed when a padding_mask is passed
except Exception:  # pragma: no cover - optional dependency
    transforms = None

from .shims import optimized_attention, pad_to_patch_size
from . import shims as quant_ops  # exposes quant_ops.ck.apply_rope_split_half
...
class MiniTrainDIT(nn.Module):
    ...
    def forward(self,
        ...
        **kwargs,
        ...
        # ComfyUI wraps _forward with its hook system; standalone we call directly.
